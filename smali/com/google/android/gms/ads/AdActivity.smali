...
.method private final a()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/ads/AdActivity;->a:Ljay;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Ljay;->a(IILandroid/content/Intent;)V
    :try_end_0
...
.method public onBackPressed()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/android/gms/ads/AdActivity;->a:Ljay;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/gms/ads/AdActivity;->a:Ljay;

    invoke-interface {v1}, Ljay;->i()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-interface {v0, v1}, Ljay;->a(Lisn;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v0, v0, Lidq;->b:Lidm;

    .line 2000
    const-string v1, "com.google.android.gms.ads.internal.overlay.useClientJar"

    invoke-static {p0, v1}, Lidm;->a(Landroid/app/Activity;Ljava/lang/String;)Z

    move-result v1

    new-instance v2, Lido;

    invoke-direct {v2, v0, p0}, Lido;-><init>(Lidm;Landroid/app/Activity;)V

    invoke-static {p0, v1, v2}, Lidm;->a(Landroid/content/Context;ZLidp;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Ljay;

    iput-object v0, p0, Lcom/google/android/gms/ads/AdActivity;->a:Ljay;
    ...
    invoke-static {v0}, Liew;->b(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Ljay;->a(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, Ljay;->b(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
