...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 47
    iput-object p1, p0, Lamy;->c:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 75
    invoke-direct {p0, v0, p2}, Lamy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lamy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 99
    iget-object v0, p0, Lamy;->a:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 100
    iput-object v1, p0, Lamy;->a:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 51
    iget-object v0, p0, Lamy;->c:Landroid/widget/ProgressBar;
    ...
    invoke-static {v0, p1, v1, p2, v3}, Lasy;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lasy;

    move-result-object v4

    .line 54
    invoke-virtual {v4, v3}, Lasy;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 56
    iget-object v5, p0, Lamy;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lamy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 59
    :cond_2
    invoke-virtual {v4, v9}, Lasy;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 61
    iget-object v1, p0, Lamy;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lamy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
