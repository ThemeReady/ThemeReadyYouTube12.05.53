...
.field private synthetic e:Lfgv;
...
.method public constructor <init>(Lfgv;Landroid/view/View;)V
    ...
    .prologue
    .line 256
    iput-object p1, p0, Lfgw;->e:Lfgv;

    .line 257
    invoke-direct {p0, p1, p2}, Lfgy;-><init>(Lfgv;Landroid/view/View;)V
    ...
    iput-object v0, p0, Lfgw;->d:Landroid/widget/TextView;
...
.method public final a(I)Lcyk;
    ...
    .line 263
    invoke-super {p0, p1}, Lfgy;->a(I)Lcyk;

    .line 265
    iget-object v0, p0, Lfgw;->d:Landroid/widget/TextView;

    if-eqz v0, :cond_0

    .line 266
    iget-object v1, p0, Lfgw;->d:Landroid/widget/TextView;

    iget-object v0, p0, Lfgw;->e:Lfgv;
    ...
    .line 269
    :cond_0
    iget-object v0, p0, Lfgw;->a:Landroid/widget/FrameLayout;
    ...
    iget-object v1, p0, Lfgw;->c:Lcyk;

    if-ne v0, v1, :cond_1

    .line 272
    iget-object v0, p0, Lfgw;->b:Landroid/widget/RelativeLayout;

    iget-object v1, p0, Lfgw;->e:Lfgv;
    ...
    .line 282
    :goto_0
    iget-object v3, p0, Lfgw;->e:Lfgv;

    invoke-virtual {v3}, Lfgv;->getCount()I
    ...
    .line 284
    :goto_1
    iget-object v3, p0, Lfgw;->a:Landroid/widget/FrameLayout;

    invoke-virtual {v3, v2, v0, v2, v1}, Landroid/widget/FrameLayout;->setPadding(IIII)V

    .line 287
    :cond_2
    iget-object v0, p0, Lfgw;->c:Lcyk;
