...
.field public static final HIDDEN_METHOD_INVOKER:Lasi;
...
.field public mOnCloseListener:Lasj;
...
.field public mOnQueryChangeListener:Lask;
...
.field public mOnSuggestionListener:Lasl;
...
.field public mShowImeRunnable:Ljava/lang/Runnable;
...
.field public mSuggestionsAdapter:Lyv;
...
.field public mTouchDelegate:Laso;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Lasi;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lasa;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lasb;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lasf;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lasg;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lash;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lary;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Larz;-><init>(Landroid/support/v7/widget/SearchView;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mTextWatcher:Landroid/text/TextWatcher;

    .line 298
    sget-object v0, Laey;->bv:[I

    invoke-static {p1, p2, v0, p3, v6}, Lasy;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lasy;
    ...
    invoke-virtual {v1, v2, v3}, Lasy;->g(II)I
    ...
    .line 320
    invoke-virtual {v1, v2}, Lasy;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0, v6}, Lasy;->g(II)I
    ...
    invoke-direct {v2, p0}, Lasc;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1, v0, v5}, Lasy;->a(IZ)Z
    ...
    invoke-virtual {v1, v0, v4}, Lasy;->e(II)I
    ...
    invoke-virtual {v1, v0, v4}, Lasy;->a(II)I
...
.method private addOnLayoutChangeListenerToDropDownAnchorBase()V
    ...
    invoke-direct {v1, p0}, Lase;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private addOnLayoutChangeListenerToDropDownAnchorSDK11()V
    ...
    invoke-direct {v1, p0}, Lasd;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v0}, Lasq;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2}, Lasq;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private launchSuggestion(IILjava/lang/String;)Z
    ...
    .prologue
    .line 1528
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lyv;

    .line 10207
    iget-object v0, v0, Lyv;->c:Landroid/database/Cursor;
...
.method private rewriteQueryFromSuggestion(I)V
    ...
    .line 1496
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lyv;

    .line 10207
    iget-object v1, v1, Lyv;->c:Landroid/database/Cursor;
    ...
    .line 1502
    iget-object v2, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lyv;

    invoke-virtual {v2, v1}, Lyv;->b(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-virtual {v0, v2}, Lyv;->a(Landroid/database/Cursor;)V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Lasq;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lyv;
...
.method public clearFocus()V
    ...
    .line 540
    invoke-super {p0}, Lapa;->clearFocus()V
...
.method public forceSuggestionQuery()V
    ...
    .prologue
    .line 1748
    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Lasi;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    .line 12052
    iget-object v2, v0, Lasi;->a:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_0

    .line 12054
    :try_start_0
    iget-object v0, v0, Lasi;->a:Ljava/lang/reflect/Method;
    ...
    .line 22061
    iget-object v2, v0, Lasi;->b:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_1

    .line 22063
    :try_start_1
    iget-object v0, v0, Lasi;->b:Ljava/lang/reflect/Method;
...
.method public getSuggestionsAdapter()Lyv;
    .locals 1
...
.method public onCloseClicked()V
    ...
    .line 1265
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lasj;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lasj;

    invoke-interface {v0}, Lasj;->a()Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 1007
    invoke-super {p0}, Lapa;->onDetachedFromWindow()V
...
.method public onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1439
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lasl;
...
.method public onItemSelected(I)Z
    ...
    .prologue
    .line 1450
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lasl;
...
.method protected onLayout(ZIIII)V
    ...
    .line 881
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Laso;
    ...
    invoke-direct {v0, v1, v2, v3}, Laso;-><init>(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Laso;
    ...
    invoke-virtual {v0, v1, v2}, Laso;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method protected onMeasure(II)V
    ...
    .line 825
    invoke-super {p0, p1, p2}, Lapa;->onMeasure(II)V
    ...
    .line 867
    invoke-super {p0, v0, v1}, Lapa;->onMeasure(II)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1405
    invoke-super {p0, p1}, Lapa;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Lapa;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    .line 1410
    iget-boolean v0, p1, Lasm;->a:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .prologue
    .line 1396
    invoke-super {p0}, Lapa;->onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lasm;-><init>(Landroid/os/Parcelable;)V
...
.method public onSubmitQuery()V
    ...
    .line 1245
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lask;
...
.method public onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1}, Lasi;->a(Landroid/widget/AutoCompleteTextView;)V
...
.method public onTextChanged(Ljava/lang/CharSequence;)V
    ...
    .line 1236
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lask;
...
.method public onWindowFocusChanged(Z)V
    ...
    .prologue
    .line 1324
    invoke-super {p0, p1}, Lapa;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    .line 530
    :cond_3
    invoke-super {p0, p1, p2}, Lapa;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Lasj;)V
    .locals 0

    .prologue
    .line 561
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lasj;
...
.method public setOnQueryTextListener(Lask;)V
    .locals 0

    .prologue
    .line 552
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lask;
...
.method public setOnSuggestionListener(Lasl;)V
    .locals 0

    .prologue
    .line 579
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lasl;
...
.method public setSuggestionsAdapter(Lyv;)V
    .locals 2

    .prologue
    .line 786
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lyv;
