...
# virtual methods
.method public final a(Lhem;Lhey;Lhfe;Lhfh;Lhej;Lheg;Lhfk;Lhep;Lhev;Lhfb;Lhfn;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    .locals 5
    ...
    invoke-interface {p1}, Lhem;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Lhey;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Lhfe;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lhfh;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lhej;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lheg;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lhfk;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Lhep;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lhev;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Lhfb;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Lhfn;->asBinder()Landroid/os/IBinder;
