...
# direct methods
.method public constructor <init>(Lvbd;Lnco;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, v0}, Llns;-><init>(Lvbd;Lnco;Ljava/util/TimeZone;)V

    .line 40
    return-void
.end method

.method private constructor <init>(Lvbd;Lnco;Ljava/util/TimeZone;)V
    .locals 1
    ...
    iput-object v0, p0, Llns;->f:Ljava/util/TimeZone;
...
# virtual methods
.method public final a(Lowr;Landroid/net/Uri;)Ljava/util/List;
    .locals 8
    ...
    .line 137
    invoke-interface {p1}, Lowr;->g()Ljava/lang/String;
    ...
    :goto_0
    iget-wide v4, p0, Llns;->d:J

    iget-wide v6, p0, Llns;->c:J
    ...
    .line 147
    iget-wide v0, p0, Llns;->d:J

    iget-object v4, p0, Llns;->f:Ljava/util/TimeZone;
    ...
    .line 152
    invoke-interface {p1}, Lowr;->e()Lowq;
    ...
    .line 156
    :goto_2
    invoke-interface {p1}, Lowr;->d()Ljava/lang/String;
    ...
    .line 166
    :goto_4
    invoke-interface {p1}, Lowr;->h()Ljava/util/List;
