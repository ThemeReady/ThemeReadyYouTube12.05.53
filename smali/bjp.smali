...
.field public static final b:Lbal;

.field public static final c:Lbjr;

.field private static d:Lbal;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbjp;->e:Ljava/util/Set;
    ...
    sput-object v0, Lbjp;->f:Ljava/util/Set;

    .line 96
    invoke-static {v4}, Lbog;->a(I)Ljava/util/Queue;

    move-result-object v0

    sput-object v0, Lbjp;->g:Ljava/util/Queue;

    return-void
.end method

.method public constructor <init>(Ljava/util/List;Landroid/util/DisplayMetrics;Lbdx;Lbds;)V
    .locals 1
    ...
    .line 108
    iput-object p1, p0, Lbjp;->k:Ljava/util/List;
    ...
    iput-object v0, p0, Lbjp;->i:Landroid/util/DisplayMetrics;
    ...
    iput-object v0, p0, Lbjp;->h:Lbdx;

    .line 3022
    const-string v0, "Argument must not be null"

    invoke-static {p4, v0}, Lbof;->a(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lbds;

    iput-object v0, p0, Lbjp;->j:Lbds;

    .line 112
    return-void
.end method

.method private final a(Ljava/io/InputStream;Lbad;)Landroid/graphics/Bitmap$Config;
    .locals 4
    ...
    .line 376
    :try_start_0
    iget-object v1, p0, Lbjp;->k:Ljava/util/List;

    iget-object v2, p0, Lbjp;->j:Lbds;
...
.method private static a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbjr;)Landroid/graphics/Bitmap;
    .locals 8
    ...
    .line 1059
    sget-object v3, Lbjx;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 3485
    invoke-static {p1}, Lbjp;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
...
.method private final a(Ljava/io/InputStream;)Z
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lbjp;->k:Ljava/util/List;

    iget-object v1, p0, Lbjp;->j:Lbds;
    ...
    .line 358
    sget-object v1, Lbjp;->f:Ljava/util/Set;
...
.method private static b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lbjp;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method private static declared-synchronized c()Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    sget-object v2, Lbjp;->g:Ljava/util/Queue;
    ...
    .line 501
    :try_start_1
    sget-object v0, Lbjp;->g:Ljava/util/Queue;
    ...
    .line 505
    invoke-static {v0}, Lbjp;->d(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
.method private static c(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 512
    invoke-static {p0}, Lbjp;->d(Landroid/graphics/BitmapFactory$Options;)V

    .line 513
    sget-object v1, Lbjp;->g:Ljava/util/Queue;
...
# virtual methods
.method public final a(Ljava/io/InputStream;IILbao;Lbjr;)Lbdl;
    .locals 18
    ...
    invoke-static {v2, v3}, Lbof;->a(ZLjava/lang/String;)V

    .line 166
    move-object/from16 v0, p0

    iget-object v2, v0, Lbjp;->j:Lbds;

    const/high16 v3, 0x10000

    const-class v4, [B

    invoke-interface {v2, v3, v4}, Lbds;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    .line 167
    invoke-static {}, Lbjp;->c()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 170
    sget-object v3, Lbjp;->a:Lbal;

    move-object/from16 v0, p4

    invoke-virtual {v0, v3}, Lbao;->a(Lbal;)Ljava/lang/Object;
    ...
    .line 171
    sget-object v4, Lbjp;->b:Lbal;

    move-object/from16 v0, p4

    invoke-virtual {v0, v4}, Lbao;->a(Lbal;)Ljava/lang/Object;
    ...
    .line 172
    sget-object v5, Lbjp;->d:Lbal;

    move-object/from16 v0, p4

    invoke-virtual {v0, v5}, Lbao;->a(Lbal;)Ljava/lang/Object;
    ...
    invoke-static {v0, v9, v1}, Lbjp;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbjr;)Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Lbjp;->k:Ljava/util/List;

    move-object/from16 v0, p0

    iget-object v6, v0, Lbjp;->j:Lbds;

    move-object/from16 v0, p1

    invoke-static {v5, v0, v6}, Lbaj;->b(Ljava/util/List;Ljava/io/InputStream;Lbds;)I

    move-result v12

    .line 1196
    invoke-static {v12}, Lbjx;->a(I)I
    ...
    invoke-direct {v0, v1, v3}, Lbjp;->a(Ljava/io/InputStream;Lbad;)Landroid/graphics/Bitmap$Config;
    ...
    .line 1212
    :cond_2
    invoke-direct/range {p0 .. p1}, Lbjp;->a(Ljava/io/InputStream;)Z
    ...
    invoke-interface {v5, v4, v3, v6}, Lbdx;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v0, Lbjp;->h:Lbdx;

    move-object/from16 v0, p5

    invoke-interface {v0, v3, v4}, Lbjr;->a(Lbdx;Landroid/graphics/Bitmap;)V
    ...
    .line 5444
    invoke-static {v4}, Lbjp;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    .line 5446
    invoke-static {v9}, Lbjp;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    iget-object v3, v0, Lbjp;->i:Landroid/util/DisplayMetrics;
    ...
    invoke-static {v3, v4, v12}, Lbjx;->a(Lbdx;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v5, v4}, Lbdx;->a(Landroid/graphics/Bitmap;)V

    .line 178
    :cond_6
    move-object/from16 v0, p0

    iget-object v4, v0, Lbjp;->h:Lbdx;

    invoke-static {v3, v4}, Lbiz;->a(Landroid/graphics/Bitmap;Lbdx;)Lbiz;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 180
    invoke-static {v9}, Lbjp;->c(Landroid/graphics/BitmapFactory$Options;)V

    .line 181
    move-object/from16 v0, p0

    iget-object v4, v0, Lbjp;->j:Lbds;

    const-class v5, [B

    invoke-interface {v4, v2, v5}, Lbds;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    :cond_a
    :try_start_1
    invoke-virtual {v4, v7, v8, v5, v3}, Lbji;->a(IIII)F
    ...
    :cond_b
    :try_start_2
    invoke-virtual {v4, v8, v7, v5, v3}, Lbji;->a(IIII)F
    ...
    sget-object v14, Lbjp;->e:Ljava/util/Set;
    ...
    .line 3329
    :cond_f
    invoke-static {v9}, Lbjp;->a(Landroid/graphics/BitmapFactory$Options;)Z
